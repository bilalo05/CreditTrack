...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 15, 2026 at 02:19 PM
...
CREATE TABLE `debt` (
  ...
  `product_picture` varchar(333) NOT NULL,
...
CREATE TABLE `debtor` (
  ...
  `lastname` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `current_debit` int(11) NOT NULL DEFAULT 0,
  `store_id` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Table structure for table `firebasetest`
--

CREATE TABLE `firebasetest` (
...
ALTER TABLE `clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `store_id_client` (`store_id`);
...
ALTER TABLE `debt`
  ...
  ADD KEY `debtor_id_product` (`debtor_id`);
...
ALTER TABLE `notification`
  ADD PRIMARY KEY (`id`),
  ADD KEY `notification_store_id_foreign` (`store_id`);
...
--
ALTER TABLE `clients`
  ADD CONSTRAINT `store_id_client` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`);

--
-- Constraints for table `debt`
--
ALTER TABLE `debt`
  ADD CONSTRAINT `debtor_id_product` FOREIGN KEY (`debtor_id`) REFERENCES `debtor` (`id`);
...
--
ALTER TABLE `notification`
  ADD CONSTRAINT `notification_store_id_foreign` FOREIGN KEY (`store_id`) REFERENCES `stores` (`id`);
COMMIT;
